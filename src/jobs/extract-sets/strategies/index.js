...
module.exports = {
    noWeightStraightSetStrategy(row) {
    ...
    differentWeightsPerSetStrategy(row) {
    ...
    differentRepsPerSetsStrategy(row) {
    ...
    plusSignDelimitedRepsDropSetStrategy(row) {
    ...
    failureSpecifiedInRepsColumnAndNoWeightStrategy(row) {
    ...
    repRangeInParenthesisStrategy(row) {
        // TODO
        return false;
    },
    catchAllStrategy(row) {
